...
function Wishsection() {
    ...
    return <><div className='h-screen bg-[#023047] flex flex-col items-center justify-center'>
        ...
        <div className="w-[349px] h-[314px] rounded max-sm:w-[225px] max-sm:h-[250px] bg-cover" style={{ backgroundImage: `url("/1.png")` }}></div>
        <h1 className="font-mukta text-white text-8xl font-bold m-5 max-sm:text-4xl"><Typewriter
            options={{
                strings: ['<span style="color: #29E7CD;">Calista </span>', ' <span style="color: #F0F0C9;">babe</span>', '<span style="color: #D4F5F5;">Candy</span>'],
                delay: 200,
                autoStart: true,
                loop: true,
                cursor: ''
